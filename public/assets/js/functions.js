        ...
        mercado_clone_all_zan_menus: function() {
            ...
            $('.clone-main-menu').each(function () {
                ...
                if (!$('#' + this_menu_clone_id).length) {
                    ...
                    $('.mercado-clone-wrap .mercado-panels #mercado-main-panel ul').append('<li class="menu-item open-menu" data-foo="foo"><a data-target="#'+thisMenuId+'" class="mercado-next-panel" href="#'+thisMenuId+'"></a><a title="'+thisMenuname+'" class="mercado-item-title" href="#">'+thisMenuname+'</a></li>');
        ...
        mercado_control_panel: function() {
            $(document).on('click', '.open-menu', function (e) {
                var _this     = $(this),
                    ...
                    target_data = _this.attr('data-foo'),
                    target_id = _this.children().attr('href');
                    // console.log(_this.children().attr('href'));
                if ($(target_data)) {
            ...
            if($(".products-cart .pr-cart-item").length > 0){
                $(document).on('click', '.pr-cart-item .delete .btn-delete', function(event) {
                    ...
                    $(this).closest('.pr-cart-item').remove();
                     axios.delete(`/cart/`+ $(this).attr('data-id'))
